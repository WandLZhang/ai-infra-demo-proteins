    ...
    <div style={{ width: '100vw', height: '100vh', background: '#171717', overflow: 'hidden', position: 'relative' }}>
      ...
      <InfoButton
        ...
        sections={
          ...
          phase === 'models1' ? [
            { body: '<i>"Six days ago at <a href="https://blog.google/innovation-and-ai/technology/ai/google-io-2026-all-our-announcements/" target="_blank">Google I/O 2026</a>, Demis Hassabis closed the keynote with this line: \'We are standing in the foothills of the singularity.\' Pushmeet Kohli, our Cloud Chief Scientist, sharpened it in</i> Daedalus<i>: \'We are moving toward AI that doesn\'t just facilitate science but begins to do science.\' For NIH, that future is no longer aspirational — it shipped on May 19."</i>\n\n<b>Start with the baseline.</b> In the <a href="https://www.nature.com/nature-index/research-leaders/2025/institution/corporate/all/global" target="_blank">Nature Index corporate research rankings</a>, <b>Alphabet is #3 globally</b>, behind only Roche and AstraZeneca. <b>Microsoft is #27. Amazon is #90.</b> Google publishes <b>300+ health publications a year, 15+ in JAMA, 50+ in Nature</b>. This is the only commercial cloud whose research institution operates at pharma-incumbent scale.\n\n<b>The Google-exclusive science model catalog:</b>\n\n<ul style="margin: 8px 0; padding-left: 18px; list-style-type: none;"><li style="margin-bottom: 10px; padding-left: 12px; border-left: 2px solid #2a2a2a;"><a href="https://deepmind.google/technologies/alphafold/" target="_blank"><b>AlphaFold</b></a> — <b>Nobel Prize in Chemistry 2024 (John Jumper)</b>. Used by <b>3 million researchers across 190+ countries</b> as of Q1 2026. Still the most-cited tool in life-science AI history.</li><li style="margin-bottom: 10px; padding-left: 12px; border-left: 2px solid #2a2a2a;"><a href="https://deepmind.google/technologies/alphagenome/" target="_blank"><b>AlphaGenome</b></a> — processes <b>1 megabyte of DNA per inference</b>, predicts <b>5,930 human genome tracks</b> across diverse cell types and <b>11 output modalities</b>. Cracks the <b>98% of non-coding DNA</b> that no prior model could meaningfully interpret. Free for academic research on GitHub.</li><li style="margin-bottom: 10px; padding-left: 12px; border-left: 2px solid #2a2a2a;"><a href="https://research.google/blog/accelerating-scientific-breakthroughs-with-an-ai-co-scientist/" target="_blank"><b>AI Co-Scientist</b></a> — <b>published in <i>Nature</i> on May 19, 2026</b>, same day as the I/O keynote. Imperial College London\'s Fleming Initiative tested it on antimicrobial resistance: Co-Scientist <b>proposed the same hypothesis Prof. José Penadés\' lab had reached through a decade of bench work — in hours, not years</b>. Stanford\'s Gary Peltz, writing in <i>Nature Medicine</i>, compared using it to <i>"consulting the oracle of Delphi."</i></li><li style="margin-bottom: 10px; padding-left: 12px; border-left: 2px solid #2a2a2a;"><a href="https://blog.google/innovation-and-ai/technology/research/gemini-for-science-io-2026/" target="_blank"><b>ERA (Empirical Research Assistance)</b></a> — also published in <i>Nature</i> on May 19. <b>Beat the CDC\'s own COVID-19 hospitalization forecasting ensemble</b> in head-to-head benchmarks.</li><li style="margin-bottom: 10px; padding-left: 12px; border-left: 2px solid #2a2a2a;"><a href="https://deepmind.google/technologies/alphaevolve/" target="_blank"><b>AlphaEvolve</b></a> — agentic research engine that generates and scores thousands of code variations in parallel. <b>BASF is using it in production</b> to accelerate supply-chain decisions across their global network.</li><li style="margin-bottom: 10px; padding-left: 12px; border-left: 2px solid #2a2a2a;"><a href="https://research.google/blog/fast-accurate-climate-modeling-with-neuralgcm/" target="_blank"><b>WeatherNext</b></a> — the I/O keynote highlight: WeatherNext provided <b>advance landfall warning for Hurricane Melissa</b> to Jamaica that likely saved lives.</li><li style="margin-bottom: 0; padding-left: 12px; border-left: 2px solid #2a2a2a;"><a href="https://github.com/google/deepvariant" target="_blank"><b>DeepVariant</b></a>, <a href="https://cloud.google.com/vertex-ai/generative-ai/docs/model-garden/explore-models" target="_blank"><b>TxGemma-9B</b></a>, <a href="https://cloud.google.com/vertex-ai/generative-ai/docs/model-garden/explore-models" target="_blank"><b>MedSigLIP</b></a>, <a href="https://deepmind.google/technologies/alphaearth/" target="_blank"><b>AlphaEarth Foundations</b></a> — variant calling, therapeutic LLM, medical multimodal, environmental sensing. <b>All Google-only.</b> GATK, SAMtools, BWA, Nextflow run on any cloud. <b>These don\'t.</b></li></ul>' },
          ] :
          phase === 'models2' ? [
            { body: '<b>New at I/O 2026 — <a href="https://blog.google/innovation-and-ai/technology/research/gemini-for-science-io-2026/" target="_blank">Gemini for Science</a>.</b> James Manyika and Pushmeet Kohli launched an agentic platform aimed at automating the most labor-intensive phases of research. <b>Three Google Labs experiments shipped May 19</b> (registration at <a href="https://labs.google/science" target="_blank">labs.google/science</a>):\n\n<ul style="margin: 8px 0; padding-left: 18px; list-style-type: none;"><li style="margin-bottom: 10px; padding-left: 12px; border-left: 2px solid #2a2a2a;"><b>Hypothesis Generation</b> (built on Co-Scientist) — multi-agent <i>"idea tournament"</i> where hypotheses are generated, debated, and verified with clickable citations.</li><li style="margin-bottom: 10px; padding-left: 12px; border-left: 2px solid #2a2a2a;"><b>Computational Discovery</b> (built on AlphaEvolve + ERA) — parallel code-variant search for scientific simulation.</li><li style="margin-bottom: 0; padding-left: 12px; border-left: 2px solid #2a2a2a;"><b>Literature Insights</b> — agentic synthesis across the published corpus.</li></ul>\n\n<b><a href="https://github.com/google-deepmind/science-skills" target="_blank">Science Skills</a></b> also shipped May 19 — a bundle that connects <a href="https://antigravity.google/" target="_blank"><b>Google Antigravity</b></a> agents to <b>30+ life-science databases</b>: UniProt, AlphaFold Database, AlphaGenome API, InterPro, and more. In Google\'s internal validation, a structural bioinformatics analysis on the <b>AK2 gene</b> that normally takes hours completed in <b>minutes</b>, surfacing new disease mechanism candidates. For Biowulf\'s structural biologists, this collapses days of manual workflow into a single prompt.\n\n<b>Scientific peer review.</b> Google partnered with <b>ICML, STOC, and NeurIPS</b> on <b>Paper Assistant Tool (PAT)</b> and <b>ScholarPeer</b> — agentic peer-review pilots already running at the top ML conferences.' },
          ] :
          phase === 'models3' ? [
            { body: '<b><a href="https://www.isomorphiclabs.com/" target="_blank">Isomorphic Labs</a></b> — Alphabet\'s drug-discovery subsidiary built on AlphaFold — raised a <b>$2 billion Series B</b> this year, now targeting immune disorders and cancer at scale.\n\n<b>The federal precedent for NIH:</b> DeepMind just announced <a href="https://deepmind.google/blog/google-deepmind-supports-us-department-of-energy-on-genesis/" target="_blank"><b>Genesis: AI for Science</b></a> with the <b>U.S. Department of Energy</b> — the exact same federal-science model Biowulf is positioned to instantiate for HHS. Add to the academic precedents: <a href="https://cloud.google.com/customers/chop" target="_blank"><b>CHOP</b></a> (Trillium TPUs for 1.6M pediatric patients), <a href="https://www.cmu.edu/news/stories/archives/2025/March/google-partnership" target="_blank"><b>CMU</b></a>, <a href="https://www.purdue.edu/newsroom/2026/Q1/purdue-and-google-public-sector-partner-to-scale-ai-integration-and-accelerate-education-and-research-across-the-institution/" target="_blank"><b>Purdue</b></a> (256-chip TPU pod on-prem with Slurm), <b>SUNY</b> (64 campuses, 230+ researchers in Year 1), <a href="https://www.odu.edu/article/old-dominion-university-and-google-launch-a-first-of-its-kind-ai-incubator-for-higher" target="_blank"><b>ODU</b></a>.\n\nOne last frame. Google invented the technological substrate underneath all of this: the <a href="https://arxiv.org/abs/1706.03762" target="_blank"><b>Transformer</b></a>, <a href="https://www.tensorflow.org/" target="_blank"><b>TensorFlow</b></a>, <a href="https://kubernetes.io/" target="_blank"><b>Kubernetes</b></a>, <a href="https://jax.readthedocs.io/" target="_blank"><b>JAX</b></a>. The infrastructure we walked through today — Slurm-burst, TPU, Hyperdisk ML, Falcon, Multi-Tier Checkpointing — <b>exists <i>because</i> the science layer above demands it</b>. Biowulf gets both halves of the stack from a single vendor with the deepest scientific publication record in the industry.' },
          ] :
          [
